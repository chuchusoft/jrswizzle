/*******************************************************************************
	JRSwizzle.m
		...
		Modifications for class method swizzling (c) 2009 Vincent Tan: <http://chuchusoft.com>
		Some rights reserved: <http://opensource.org/licenses/mit-license.php>
	***************************************************************************/
...
@interface NSObject ()
+ (BOOL)_jr_swizzleInClass:(Class)class_ method:(SEL)origSel_ withMethod:(SEL)altSel_ error:(NSError**)error_;
@end
...
+ (BOOL)jr_swizzleMethod:(SEL)origSel_ withMethod:(SEL)altSel_ error:(NSError**)error_ {
	return [self _jr_swizzleInClass:[self class] method:origSel_ withMethod:altSel_ error:error_];
}

+ (BOOL)jr_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
	//	pass metaclass to -_jr_swizzleInClass so that a class method get swizzled (and not an instance method)
	return [self _jr_swizzleInClass:[self class]->isa method:origSel_ withMethod:altSel_ error:error_];
}
